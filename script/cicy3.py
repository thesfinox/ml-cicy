...
def main():
    ...
    lasso.compute(DB_NAME, n_iter=30, rounding=np.floor, seed=RAND)
    elastic_net.compute(DB_NAME, n_iter=30, rounding=np.floor, seed=RAND)
    ridge.compute(DB_NAME, n_iter=30, rounding=np.floor, seed=RAND)
    linear_svr.compute(DB_NAME, n_iter=30, rounding=np.floor, seed=RAND)
    svr_rbf.compute(DB_NAME, n_iter=30, rounding=np.rint, seed=RAND)
