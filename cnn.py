...
# labels
lab_out_train_80 = {'h11_output': dat_out_train_80['h11'].values.reshape(-1,1),
                    'h21_output': dat_out_train_80['h21'].values.reshape(-1,1),
                   }
lab_noout_train_80 = {'h11_output': dat_noout_train_80['h11'].values.reshape(-1,1),
                      'h21_output': dat_noout_train_80['h21'].values.reshape(-1,1),
                     }
lab_out_train_30 = {'h11_output': dat_out_train_30['h11'].values.reshape(-1,1),
                    'h21_output': dat_out_train_30['h21'].values.reshape(-1,1),
                   }
lab_noout_train_30 = {'h11_output': dat_noout_train_30['h11'].values.reshape(-1,1),
                      'h21_output': dat_noout_train_30['h21'].values.reshape(-1,1),
                     }

lab_out_val_80   = {'h11_output': dat_out_val_80['h11'].values.reshape(-1,1),
                    'h21_output': dat_out_val_80['h21'].values.reshape(-1,1),
                   }
lab_noout_val_80   = {'h11_output': dat_noout_val_80['h11'].values.reshape(-1,1),
                      'h21_output': dat_noout_val_80['h21'].values.reshape(-1,1),
                     }
lab_out_val_30   = {'h11_output': dat_out_val_30['h11'].values.reshape(-1,1),
                    'h21_output': dat_out_val_30['h21'].values.reshape(-1,1),
                   }
lab_noout_val_30   = {'h11_output': dat_noout_val_30['h11'].values.reshape(-1,1),
                      'h21_output': dat_noout_val_30['h21'].values.reshape(-1,1),
                     }


lab_out_test_80   = {'h11_output': dat_out_test_80['h11'].values.reshape(-1,1),
                     'h21_output': dat_out_test_80['h21'].values.reshape(-1,1),
                    }
lab_noout_test_80   = {'h11_output': dat_noout_test_80['h11'].values.reshape(-1,1),
                       'h21_output': dat_noout_test_80['h21'].values.reshape(-1,1),
                      }
lab_out_test_30   = {'h11_output': dat_out_test_30['h11'].values.reshape(-1,1),
                     'h21_output': dat_out_test_30['h21'].values.reshape(-1,1),
                    }
lab_noout_test_30   = {'h11_output': dat_noout_test_30['h11'].values.reshape(-1,1),
                       'h21_output': dat_noout_test_30['h21'].values.reshape(-1,1),
                      }
...
def inc_model(input_shape,
    ...
    h21 = keras.layers.Dense(units=1,
                             activation='relu',
                             name='h21_output'
                            )(x)
    ...
    # prepare dictionary
    output_layers = {}
    output_layers['h11_output'] = h11
    output_layers['h21_output'] = h21
    
    weights = {'h11_output': rho,
               'h21_output': 1 - rho
              }
    
    # define the model
    model = keras.models.Model(inputs=I, outputs=output_layers, name=model_name)
...
inception_line_dot.write_pdf('./img/inc_arch.pdf')
...
callbacks = [keras.callbacks.ModelCheckpoint('./mod/inception_line_out_80.h5',
                                             monitor='val_loss',
                                             verbose=0,
                                             save_best_only=True
                                            ),
...
# predictions
h11_pred = np.rint(inception_line.predict(mat_out_test_80)['h11_output']).astype(int).reshape(-1,)
h21_pred = np.rint(inception_line.predict(mat_out_test_80)['h21_output']).astype(int).reshape(-1,)

# true values
h11_true = lab_out_test_80['h11_output'].astype(int).reshape(-1,)
h21_true = lab_out_test_80['h21_output'].astype(int).reshape(-1,)

# accuracy
h11_acc = np.mean((h11_pred == h11_true).astype(int))
h21_acc = np.mean((h21_pred == h21_true).astype(int))
...
predictions.to_csv('./dat/inc_line_out_80.csv')

# save history
joblib.dump(inc_line_out_80.history, './dat/inc_line_out_80.pkl')

# print accuracy
print('Accuracy for h_11: {:.2f}%'.format(h11_acc * 100))
print('Accuracy for h_21: {:.2f}%'.format(h21_acc * 100))
...
callbacks = [keras.callbacks.ModelCheckpoint('./mod/inception_line_noout_80.h5',
                                             monitor='val_loss',
                                             verbose=0,
                                             save_best_only=True
                                            ),
...
# predictions
h11_pred = np.rint(inception_line.predict(mat_noout_test_80)['h11_output']).astype(int).reshape(-1,)
h21_pred = np.rint(inception_line.predict(mat_noout_test_80)['h21_output']).astype(int).reshape(-1,)

# true values
h11_true = lab_noout_test_80['h11_output'].astype(int).reshape(-1,)
h21_true = lab_noout_test_80['h21_output'].astype(int).reshape(-1,)
...
predictions = pd.DataFrame(predictions)
predictions.to_csv('./dat/inc_line_noout_80.csv')

# save history
joblib.dump(inc_line_noout_80.history, './dat/inc_line_noout_80.pkl')
...
callbacks = [keras.callbacks.ModelCheckpoint('./mod/inception_line_out_30.h5',
                                             monitor='val_loss',
                                             verbose=0,
                                             save_best_only=True
                                            ),
...
# predictions
h11_pred = np.rint(inception_line.predict(mat_out_test_30)['h11_output']).astype(int).reshape(-1,)
h21_pred = np.rint(inception_line.predict(mat_out_test_30)['h21_output']).astype(int).reshape(-1,)

# true values
h11_true = lab_out_test_30['h11_output'].astype(int).reshape(-1,)
h21_true = lab_out_test_30['h21_output'].astype(int).reshape(-1,)
...
predictions = pd.DataFrame(predictions)
predictions.to_csv('./dat/inc_line_out_30.csv')

# save history
joblib.dump(inc_line_out_30.history, './dat/inc_line_out_30.pkl')
...
callbacks = [keras.callbacks.ModelCheckpoint('./mod/inception_line_noout_30.h5',
                                             monitor='val_loss',
                                             verbose=0,
                                             save_best_only=True
                                            ),
...
# predictions
h11_pred = np.rint(inception_line.predict(mat_noout_test_30)['h11_output']).astype(int).reshape(-1,)
h21_pred = np.rint(inception_line.predict(mat_noout_test_30)['h21_output']).astype(int).reshape(-1,)

# true values
h11_true = lab_noout_test_30['h11_output'].astype(int).reshape(-1,)
h21_true = lab_noout_test_30['h21_output'].astype(int).reshape(-1,)
...
predictions = pd.DataFrame(predictions)
predictions.to_csv('./dat/inc_line_noout_30.csv')

# save history
joblib.dump(inc_line_noout_30.history, './dat/inc_line_noout_30.pkl')
...
callbacks = [keras.callbacks.ModelCheckpoint('./mod/inception_square_out_80.h5',
                                             monitor='val_loss',
                                             verbose=0,
                                             save_best_only=True
                                            ),
...
# predictions
h11_pred = np.rint(inception_square.predict(mat_out_test_80)['h11_output']).astype(int).reshape(-1,)
h21_pred = np.rint(inception_square.predict(mat_out_test_80)['h21_output']).astype(int).reshape(-1,)
...
predictions = pd.DataFrame(predictions)
predictions.to_csv('./dat/inc_square_out_80.csv')

# save history
joblib.dump(inc_square_out_80.history, './dat/inc_square_out_80.pkl')
...
callbacks = [keras.callbacks.ModelCheckpoint('./mod/inception_square_noout_80.h5',
                                             monitor='val_loss',
                                             verbose=0,
                                             save_best_only=True
                                            ),
...
# predictions
h11_pred = np.rint(inception_square.predict(mat_noout_test_80)['h11_output']).astype(int).reshape(-1,)
h21_pred = np.rint(inception_square.predict(mat_noout_test_80)['h21_output']).astype(int).reshape(-1,)
...
predictions = pd.DataFrame(predictions)
predictions.to_csv('./dat/inc_square_noout_80.csv')

# save history
joblib.dump(inc_square_noout_80.history, './dat/inc_square_noout_80.pkl')
...
callbacks = [keras.callbacks.ModelCheckpoint('./mod/inception_square_out_30.h5',
                                             monitor='val_loss',
                                             verbose=0,
                                             save_best_only=True
                                            ),
...
# predictions
h11_pred = np.rint(inception_square.predict(mat_out_test_30)['h11_output']).astype(int).reshape(-1,)
h21_pred = np.rint(inception_square.predict(mat_out_test_30)['h21_output']).astype(int).reshape(-1,)
...
predictions = pd.DataFrame(predictions)
predictions.to_csv('./dat/inc_square_out_30.csv')

# save history
joblib.dump(inc_square_out_30.history, './dat/inc_square_out_30.pkl')
...
callbacks = [keras.callbacks.ModelCheckpoint('./mod/inception_square_noout_30.h5',
                                             monitor='val_loss',
                                             verbose=0,
                                             save_best_only=True
                                            ),
...
# predictions
h11_pred = np.rint(inception_square.predict(mat_noout_test_30)['h11_output']).astype(int).reshape(-1,)
h21_pred = np.rint(inception_square.predict(mat_noout_test_30)['h21_output']).astype(int).reshape(-1,)
...
predictions = pd.DataFrame(predictions)
predictions.to_csv('./dat/inc_square_noout_30.csv')

# save history
joblib.dump(inc_square_noout_30.history, './dat/inc_square_noout_30.pkl')
...
sequential_dot.write_pdf('./img/seq_arch.pdf')
...
callbacks = [keras.callbacks.ModelCheckpoint('./mod/sequential_small_out_80.h5',
                                             monitor='val_loss',
                                             verbose=0,
                                             save_best_only=True
                                            ),
...
# predictions
h11_pred = np.rint(sequential_small.predict(mat_out_test_80)['h11_output']).astype(int).reshape(-1,)
h21_pred = np.rint(sequential_small.predict(mat_out_test_80)['h21_output']).astype(int).reshape(-1,)
...
predictions = pd.DataFrame(predictions)
predictions.to_csv('./dat/seq_small_out_80.csv')

# save history
joblib.dump(seq_small_out_80.history, './dat/seq_small_out_80.pkl')
...
callbacks = [keras.callbacks.ModelCheckpoint('./mod/sequential_small_noout_80.h5',
                                             monitor='val_loss',
                                             verbose=0,
                                             save_best_only=True
                                            ),
...
# predictions
h11_pred = np.rint(sequential_small.predict(mat_noout_test_80)['h11_output']).astype(int).reshape(-1,)
h21_pred = np.rint(sequential_small.predict(mat_noout_test_80)['h21_output']).astype(int).reshape(-1,)
...
predictions = pd.DataFrame(predictions)
predictions.to_csv('./dat/seq_small_noout_80.csv')

# save history
joblib.dump(seq_small_noout_80.history, './dat/seq_small_noout_80.pkl')
...
callbacks = [keras.callbacks.ModelCheckpoint('./mod/sequential_small_out_30.h5',
                                             monitor='val_loss',
                                             verbose=0,
                                             save_best_only=True
                                            ),
...
# predictions
h11_pred = np.rint(sequential_small.predict(mat_out_test_30)['h11_output']).astype(int).reshape(-1,)
h21_pred = np.rint(sequential_small.predict(mat_out_test_30)['h21_output']).astype(int).reshape(-1,)
...
predictions = pd.DataFrame(predictions)
predictions.to_csv('./dat/seq_small_out_30.csv')

# save history
joblib.dump(seq_small_out_30.history, './dat/seq_small_out_30.pkl')
...
callbacks = [keras.callbacks.ModelCheckpoint('./mod/sequential_small_noout_30.h5',
                                             monitor='val_loss',
                                             verbose=0,
                                             save_best_only=True
                                            ),
...
# predictions
h11_pred = np.rint(sequential_small.predict(mat_noout_test_30)['h11_output']).astype(int).reshape(-1,)
h21_pred = np.rint(sequential_small.predict(mat_noout_test_30)['h21_output']).astype(int).reshape(-1,)
...
predictions = pd.DataFrame(predictions)
predictions.to_csv('./dat/seq_small_noout_30.csv')

# save history
joblib.dump(seq_small_noout_30.history, './dat/seq_small_noout_30.pkl')
...
callbacks = [keras.callbacks.ModelCheckpoint('./mod/sequential_large_out_80.h5',
                                             monitor='val_loss',
                                             verbose=0,
                                             save_best_only=True
                                            ),
...
# predictions
h11_pred = np.rint(sequential_large.predict(mat_out_test_80)['h11_output']).astype(int).reshape(-1,)
h21_pred = np.rint(sequential_large.predict(mat_out_test_80)['h21_output']).astype(int).reshape(-1,)
...
predictions = pd.DataFrame(predictions)
predictions.to_csv('./dat/seq_large_out_80.csv')

# save history
joblib.dump(seq_large_out_80.history, './dat/seq_large_out_80.pkl')
...
callbacks = [keras.callbacks.ModelCheckpoint('./mod/sequential_large_noout_80.h5',
                                             monitor='val_loss',
                                             verbose=0,
                                             save_best_only=True
                                            ),
...
# predictions
h11_pred = np.rint(sequential_large.predict(mat_noout_test_80)['h11_output']).astype(int).reshape(-1,)
h21_pred = np.rint(sequential_large.predict(mat_noout_test_80)['h21_output']).astype(int).reshape(-1,)
...
predictions = pd.DataFrame(predictions)
predictions.to_csv('./dat/seq_large_noout_80.csv')

# save history
joblib.dump(seq_large_noout_80.history, './dat/seq_large_noout_80.pkl')
...
callbacks = [keras.callbacks.ModelCheckpoint('./mod/sequential_large_out_30.h5',
                                             monitor='val_loss',
                                             verbose=0,
                                             save_best_only=True
                                            ),
...
# predictions
h11_pred = np.rint(sequential_large.predict(mat_out_test_30)['h11_output']).astype(int).reshape(-1,)
h21_pred = np.rint(sequential_large.predict(mat_out_test_30)['h21_output']).astype(int).reshape(-1,)
...
predictions = pd.DataFrame(predictions)
predictions.to_csv('./dat/seq_large_out_30.csv')

# save history
joblib.dump(seq_large_out_30.history, './dat/seq_large_out_30.pkl')
...
callbacks = [keras.callbacks.ModelCheckpoint('./mod/sequential_large_noout_30.h5',
                                             monitor='val_loss',
                                             verbose=0,
                                             save_best_only=True
                                            ),
...
# predictions
h11_pred = np.rint(sequential_large.predict(mat_noout_test_30)['h11_output']).astype(int).reshape(-1,)
h21_pred = np.rint(sequential_large.predict(mat_noout_test_30)['h21_output']).astype(int).reshape(-1,)
...
predictions = pd.DataFrame(predictions)
predictions.to_csv('./dat/seq_large_noout_30.csv')

# save history
joblib.dump(seq_large_noout_30.history, './dat/seq_large_noout_30.pkl')
