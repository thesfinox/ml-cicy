...
def compute(df_name, n_iter=30, seed=42):
    ...
    print('Predictions of the LinearRegressor...')
    ...
    print('Predictions of the XGBRegressor...')
    ...
    print('Predictions of the XGBRFRegressor...')
    ...
    print('Fitting the LinearRegressor for h_11...')
